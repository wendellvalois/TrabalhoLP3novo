    ...
    <body>
        ...
        <nav id="nav">
            <ul>
                ...
                <li><a href="/TrabalhoLP3novo/aluno/paginainicial.jsp">Home</a></li>
        ...
        <div id="nav-left">
            <ul>
                <li><a href="/TrabalhoLP3novo/aluno/compra.jsp">Comprar</a></li>
                
                <li><a href="/TrabalhoLP3novo/Controller?classe=ControllerLogicCompra&metodo=buscarcampo">Ver Saldo</a></li>
